...
public class EmployeeCreationPage {
	...
	public boolean verifyEmployeeCreationPage() {
		return this.employerName.isDisplayed();
	}
	
	public boolean verifyEmployeeCreationReset() {
		List<WebElement> selectedOptions = new Select(this.role).getAllSelectedOptions();
		return selectedOptions.get(0).getText().equals("Select");
	}
